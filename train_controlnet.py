...
def log_validation(
    ...
    for validation_prompt, validation_image in zip(validation_prompts, validation_images):
        validation_image = Image.open(validation_image).convert("RGB").resize((512, 512)) # resize to prevent size mismatch when stacking
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default='main',
        help="The revision of the Dataset, leave as 'main' by default.",
    )
    parser.add_argument(
        "--train_data_dir",
        type=str,
